  ...
  return (
    <div className="space-y-4 sm:space-y-6 px-2 sm:px-0">
      ...
      <div className="bg-gradient-to-r from-primary-600 via-primary-700 to-primary-800 rounded-lg sm:rounded-xl shadow-lg p-3 sm:p-4 lg:p-6 text-white">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 mb-3 sm:mb-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              <h1 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold">Daftar Produk</h1>
              <p className="text-primary-100 text-[10px] sm:text-xs lg:text-sm mt-0.5 sm:mt-1">Kelola semua produk Anda di satu tempat</p>
            </div>
          </div>
          <Link
            to="/products/new"
            className="px-3 sm:px-4 lg:px-5 py-2 sm:py-2.5 bg-white/20 hover:bg-white/30 rounded-lg transition-colors flex items-center gap-1.5 sm:gap-2 font-medium text-xs sm:text-sm lg:text-base w-full sm:w-auto justify-center"
          >
      ...
      {filteredAndSortedProducts.length === 0 ? (
        ...
        <>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-3 sm:gap-4 lg:gap-5 mb-4 sm:mb-6">
            {paginatedProducts.filter(p => p && p.id).map((product) => (
            <div
              key={product.id}
              className="bg-white rounded-lg sm:rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col h-full border border-gray-100 group"
            >
              {(() => {
              ...
              <div className="p-3 sm:p-4 flex flex-col flex-1">
                <div className="flex items-start justify-between gap-2 mb-2">
                  <Link
                    to={`/products/${product.id}`}
                    className="text-sm sm:text-base font-bold text-gray-800 line-clamp-2 flex-1 hover:text-primary-700 transition-colors cursor-pointer group-hover:text-primary-700"
                  >
                    {product.name}
                  </Link>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-2 mt-auto pt-3 border-t border-gray-100">
                  <Link
                    to={`/products/${product.id}`}
                    className="flex-1 flex items-center justify-center gap-1.5 sm:gap-2 px-3 py-2 sm:py-2.5 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-lg hover:from-primary-700 hover:to-primary-800 transition-all text-xs sm:text-sm font-medium shadow-md hover:shadow-lg"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 sm:flex-none px-3 sm:px-4 py-2 sm:py-2.5 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-lg hover:from-red-700 hover:to-red-800 transition-all text-xs sm:text-sm font-medium shadow-md hover:shadow-lg flex items-center justify-center gap-1.5 sm:gap-2"
                  >
