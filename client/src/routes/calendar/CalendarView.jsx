                  ...
                  {selectedEvent.brief.product.imageUrl && (
                    <div className="md:col-span-1">
                      <div className="w-full aspect-square overflow-hidden rounded-lg bg-gradient-to-br from-gray-100 to-gray-200">
                        <img
                          src={selectedEvent.brief.product.imageUrl?.startsWith('http') ? selectedEvent.brief.product.imageUrl : `https://planner.kemalwicaksono.com${selectedEvent.brief.product.imageUrl}`}
