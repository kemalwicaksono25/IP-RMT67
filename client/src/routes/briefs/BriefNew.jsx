        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 mb-3 sm:mb-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold">Buat Ide Brief Baru</h1>
              <p className="text-primary-100 text-[10px] sm:text-xs lg:text-sm mt-0.5 sm:mt-1">Isi form di bawah untuk generate brief dengan AI</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex gap-4">
            {selectedProduct.imageUrl && (
              <div className="w-28 h-28 flex-shrink-0 rounded-xl overflow-hidden border-2 border-primary-200 shadow-md">
                <img
                  src={selectedProduct.imageUrl?.startsWith('http') ? selectedProduct.imageUrl : `https://planner.kemalwicaksono.com${selectedProduct.imageUrl}`}
