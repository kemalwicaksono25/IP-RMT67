      ...
      <div className="bg-gradient-to-r from-primary-600 via-primary-700 to-primary-800 rounded-lg sm:rounded-xl shadow-lg p-3 sm:p-4 lg:p-6 text-white">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 mb-3 sm:mb-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              <h1 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold">Dashboard</h1>
              <p className="text-primary-100 text-[10px] sm:text-xs lg:text-sm mt-0.5 sm:mt-1">Ringkasan aktivitas dan statistik proyek Anda</p>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-3 sm:gap-4 lg:gap-5 mb-4 sm:mb-6">
              ...
              >
                ...
                <div className="p-3 sm:p-4 flex flex-col flex-1">
                  <Link
                    to={`/products/${product.id}`}
                    className="text-sm sm:text-base font-bold text-gray-800 mb-2 line-clamp-2 min-h-[2.5rem] hover:text-primary-700 transition-colors cursor-pointer group-hover:text-primary-700"
                  >
                    {product.name}
                  </Link>
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 mt-auto pt-3 border-t border-gray-100">
                    <Link
                      to={`/products/${product.id}`}
                      className="flex-1 flex items-center justify-center gap-1.5 sm:gap-2 px-3 py-2 sm:py-2.5 bg-gradient-to-r from-primary-50 to-primary-100 text-primary-700 rounded-lg hover:from-primary-100 hover:to-primary-200 transition-all text-xs sm:text-sm font-medium border border-primary-200 hover:border-primary-300 hover:shadow-sm"
                    >
